...
export default function AnalyzePage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-zinc-50 text-zinc-950">
      ...
      <main className="mx-auto grid w-full max-w-7xl min-w-0 gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[0.92fr_1.08fr] lg:px-8 lg:py-14">
        <aside className="min-w-0 lg:sticky lg:top-24 lg:h-fit">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-rose-700">{copy.eyebrow}</p>
          <h1 className="mt-3 max-w-xl break-words text-3xl font-black leading-tight tracking-tight text-zinc-950 [overflow-wrap:anywhere] sm:text-5xl sm:[word-break:keep-all] sm:[overflow-wrap:normal]">
            {copy.heroTitle}
          </h1>
        ...
        <section className="min-w-0 overflow-hidden rounded-[2rem] border border-zinc-200 bg-white p-4 shadow-xl shadow-zinc-950/5 sm:p-6 lg:p-8">
          <div className="mb-7">
            <div role="tablist" aria-label={copy.tablistLabel} className="grid min-w-0 grid-cols-3 gap-1 rounded-2xl bg-zinc-100 p-1 sm:gap-2">
              {ANALYZE_MODE_ORDER.map((key) => {
                ...
                return (
                  <button
                    ...
                    className={`relative min-w-0 rounded-xl px-1.5 py-2 text-xs font-semibold leading-tight transition [overflow-wrap:anywhere] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-950 sm:px-3 sm:py-3 sm:text-sm ${
                      active
