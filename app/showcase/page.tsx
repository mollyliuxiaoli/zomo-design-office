      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {styles.map(style => {
              const ogUrl = `/api/og?title=${encodeURIComponent(style.title)}&keywords=${encodeURIComponent(style.keywords.join(','))}&primary=${encodeURIComponent(style.primary)}&bg=${encodeURIComponent(style.bg)}&confidence=${style.confidence}&vibe=${encodeURIComponent(style.vibe)}&palette=${encodeURIComponent([style.primary, style.bg].join(','))}`;
